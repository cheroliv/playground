...
// Do not modify education.cccp.misc.Change
internal class KChange {
    private var coin2: Long = 0
    private var bill5: Long = 0
    private var bill10: Long = 0

    companion object {
        @JvmStatic
        fun main(args: Array<String>) {
            val s = 1065L // Change this value to perform other tests
            val m = optimalChange(s)
